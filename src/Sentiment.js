...
<div class="flex mb-4">
          ...
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={movie3}/>
        </div>
      </div>
    </section>
        );
